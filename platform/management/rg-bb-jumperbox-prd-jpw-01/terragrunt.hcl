...
dependency "vnet_sidecar_prd_jpw_01" {
  ...
  mock_outputs = {
    snet_jumperbox_id = "/subscriptions/82c65997-b2ba-41ef-bf8a-80bc639ea78d/resourceGroups/rg-bb-sidecar-prd-jpw-01/providers/Microsoft.Network/virtualNetworks/vnet-sidecar-jpw-01/subnets/snet-jumperbox"
  }
  # Disallow mock on apply to force real dependency output for subnet_id
